...
import { BsFillCaretDownFill, BsFillTelephoneFill, BsWhatsapp, BsFillCursorFill } from "react-icons/bs";
...
const SallerCategary = () => {
  ...
  return (
    <div>
      <Header>
        <h1 className="text-white font-black mt-1 text-lg">Saller</h1>
      </Header>
          ...
          ? data.map((val, ind) => {
            return (
              <div
                ...
                style={{ direction: "rtl" }}
              >
                <div onClick={(e)=> singleSaller(val)} className="flex cursor-pointer">
                ...
                <div className="max-w-lg">
                  ...
                  <div className="flex justify-center my-2">
                    <a style={{background:"#02ac84" , borderRadius:"50%" ,color:"white"}} className="mx-2 p-3" href='tel:${val.phone}'>
                      <BsFillTelephoneFill size={25} />
                    </a>
                    <a style={{background:"#02ac84" ,  borderRadius:"50%",color:"white"}} className="mx-2 p-3" href={val.whatsappLink}>
                      <BsWhatsapp size={25}/>
                    </a>
                    <a style={{background:"#02ac84" , borderRadius:"50%" , color:"white"}} className="mx-2 p-3" href={val.navigateLink}
                    >
