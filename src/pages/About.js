    ...
    <>
      <Header handleSideBar={handleSideBar}>
        <div className="flex justify-center  aligin-center">
          <h1 className="text-white font-black text-lg">من نحن؟</h1>
        </div>
      </Header>
      <div className="flex">
          ...
          <div className="about w-full p-2">
              ...
              <ul className="ul1">
                ...
                <ul className="ul2">
                  <li className="bg-color li">
                    مشروع تيكمي تم تطويره من طاقم مختص من قرية الغجر لخدمتكم
                    وتسهيل الحصول على احتياجاتكم. نعمل على تسهيل التواصل بين
                    الناس لشراء وايجار كل شيء اونلاين.
                  </li>
                </ul>
              </ul>
            </div>
            <div className="container-fluid">
              <ul className="ul1">
                ...
                <ul className="ul2">
                  <li className="bg-color li">
                    كل حدا بيملك اي شي حابب يأجره او يبيعه بيقدر يشاركنا وينشره
                    بتيكمي بكل سهولة وبنفس الوقت بيقدر يشوف شو في منتجات
                    بالتطبيق اذا حابب يشتريها او يستأجرها.
                  </li>
                  <li className="bg-color li">
                    وكمان بتقدر تعرض مهنتك يعني مو شرط تنشر بس منتجات، بتقدر
                    كمان تنشر مهنتك وشغلك حتى اي حدا معني يطلبك ويتواصل معك.
                  </li>
                  <li className="bg-color li">
            ...
            <div className="container-fluid">
              <ul className="ul1">
                ...
                <ul className="ul2">
                  <li className="bg-color li">
                    بالنسبة الك كبائع هي متجرك الاونلاين اللي ممكن من خلاله تبيع
                    وتأجر كل شيء عندك ويكون مصدر دخل وربح الك.
                  </li>
                  <li className="bg-color li">
                    اما بالنسبة الك كمستخدم فهي مخزنك الاونلاين اللامحدود يعني
                    اذا احتجت منتج معين بدلًا من شراؤه وتخزينه ببيتك بتقدر
                    تستأجره عن طريق تيكمي للمدة اللي بتحتاجها وهيك بتكون حصلت
                    عليه بسعر اقل من الشراء وبنفس الوقت ما بتنجبر تحجزله مساحة
                    ببيتك.
                  </li>
                </ul>
              </ul>
