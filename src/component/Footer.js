...
const Footer = () => {
  ...
  console.log(info);
  return (
    <div className="bg-black flex justify-around items-center w-full ">
      <h2 style={{fontWeight:"bolder"}} className="text-white">TakeMe</h2>
      <h2 style={{fontSize:"12px"}} className="text-white">ⓒ 2022</h2>
      <div className="flex">
