      ...
      <div className="flex-1">
        <ul className="pt-2 pb-4 space-y-1 text-sm">
          <li  className="relative rounded-sm">
            <Link to="/about" className="flex items-center p-2 space-x-3 rounded-md">
            ...
            {showLangSubMenu && (
              ...
              >
                <li>
                  ...
                  >
                    <input type="checkbox" id="submenu1" className="rounded" />
                ...
                <li>
                  <label
                    ...
                    className="flex items-center p-2 space-x-3 hover:bg-gray-100"
                  >
                    <input type="checkbox" id="submenu2" className="rounded" />
          ...
          <li className="relative rounded-sm">
            <a href={info.whatsappLink} target="_blank" className="flex items-center p-2 space-x-3 rounded-md">
              <img
                width={"25px"}
                height={"25px"}
          ...
          <li className="relative rounded-sm">
            <Link to={'/termcondition'} className="flex items-center p-2 space-x-3 rounded-md">
